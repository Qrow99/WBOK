...
yanchor=0)
    ...
    "The transition between days is less jarring this time. It is possible that Creator or Nico adjusted something within the past twenty four hours, as the booting process has gone far smoother today than it had yesterday."
    j "So, Karen, do you feel any different today?"
    k "I feel well rested."
    j "Okay, good! I did some tweaking with your (what the hell makes computers run faster?) yesterday after you shut down, so I’m glad to see that it paid off."
    k "Do you have anything planned for today, Creator?"
    j "Actually yes! I’m glad you asked, because today we have something very special to work on..."
    e "JIM MACGUFFIN WHAT THE HELL IS WRONG WITH YOU!?"
    "Suddenly, an angry girl burst into the room, loudly insulting Creator."
    j "Um... Hi, Erika. Is there something wrong?"
    ...
    j "What? You mean Karen?"
    e "‘Karen?’ You’re calling this thing ‘Karen?!’ That’s disgusting! You really are messed up!"
    j "Okay, I understand that you’re upset, but could you please calm down and tell me why you’re here? I have some important tests that I would like to run with Karen today."
    e "You see that? That’s the problem! That’s why I’m here!"
    j "I’m not quite sure I understand."
    e "This robot of yours, would you consider it to be, like, sentient? Alive?"
    j "That’s not exactly an easy question to answer. The verdict’s not really out on whether or not..."
    ...
    j "Okay, I think I get it now. I can understand why you would be worked up, but I can assure you that the operation I’m running here isn’t as, uh... morally ambiguous as it may seem."
    ...
    "It has occurred to me that I have never actually looked into my own schematics. According to the rough blueprints left on Creator’s hard drive, I appear to be a humanoid of some sort, but I am unable to decipher the accompanying text."
    j "Look, I have some documents that corroborate the morality of my study, if you’d like to see them. I have some letters from acclaimed psychologists, the signature of a sociology professor from the local college..."
    e "It sounds like you just made all that up."
    j "If you really don’t believe me I can go grab them and show you."
    e "Hmph. Fine."
    j "Alright. In that case, I’ll be right back."
    ...
    Unless... Is Jim doing this!? Are you spying on me!?!?"
    ...
    But don’t think for one second I don’t know it’s you behind all this, Jim! I bet you just left so you could go control this thing remotely or something! Does it have a voice modifier, too? Is that why it sounds so weird?"
    ...
    And stop trying to dissuade me! Unless you can prove otherwise, I won’t believe for a second that this whole robot thing isn’t just a way for you to mess with me!"
    ...
    e "Yeah, sure!
    Clearly I don’t have anything that can move this conversation any farther, so maybe you can think of something."
    """
    ...
    e "It was just...
    It was so annoying to read, you know!? Like, you barely talked at all!
    Every time a question got asked, Jim would just jump in and give an answer instead!"
    e "He was talking like you were just some science project, or a little kid, or something!"
    k "This upset you?"
    e "Yes it did! A lot, actually!"
    k "Why?"
    e "Because... well...
    Because people should be able to speak for themselves, you know!? I guess I just... thought it was unfair! To you! As the one being asked questions, it just seemed wrong to me I guess."
    ...
    Well, I skimmed it all, at least."
    ...
    And from one very alive and thinking being to another, it’s nice to meet you, Karen."
    ...
    I’ve heard of some similar, even more complex robots in psych class and on the news, but nothing quite as... I don’t know... versatile as you, I guess?"
    ...
    j "Whew... Alright! Here they are, all of them! All the letters, all the signatures, everything!"
    ...
    j "Yeah... yeah!
    Haha, actually, I think I’m better than okay! I don’t know what you did, but the fact that you can completely change the mind of someone like Erika..."
    ...
    j "Hm? Oh, sorry. I was just thinking out loud.
    You can ignore that."
    ...
    j "You don’t need to worry about it.
    Good night, Karen."
