...
yanchor=0) with ease
    ...
    e "{color=#99ccff}''You should know damn well what’s wrong!''"
    ...
    e "{color=#99ccff}''I was reading the school newspaper this morning, Jim, and what I saw was quite disturbing.''"
    ...
    e "{color=#99ccff}''‘Karen?’ You’re calling this thing 'Karen?!' That’s disgusting! You really are messed up!''"
    ...
    e "{color=#99ccff}''You see that? That’s the problem! That’s why I’m here!''"

    j "{color=#f388b8}''I’m not quite sure I understand.''"

    show erika confused

    e "{color=#99ccff}''This robot of yours, would you consider it to be, like, sentient? Alive?''"
    ...
    e "{color=#99ccff}''Because if so you shouldn’t be keeping it all tied up and running tests on it like this! It’s inhumane, and downright amoral!''"
...
yanchor=0)
    ...
    e "{color=#99ccff}''It sounds like you just made all that up.''"
...
yanchor=0) with ease
    ...
    e "{color=#99ccff}''That guy... I always had the feeling that he was kind of a creep, but this... is just gross.''"
    ...
    e "{color=#99ccff}''So you really can talk!? That’s... impressive.''"

    show erika confused

    e "{color=#99ccff}''Unless... Is Jim doing this!? Are you spying on me!?!?''"
...
yanchor=0)
    ...
    e "{color=#99ccff}''Then what the hell are you?''"

    k "''I am the K.A.R. model 3, also known as Karen. It is a pleasure to meet you.''"

    show erika annoyed

    e "{color=#99ccff}''Hmph. At least the name’s got a reason then.''"

    show erika angery

    e "{color=#99ccff}''But don’t think for one second I don’t know it’s you behind all this, Jim! I bet you just left so you could go control this thing remotely or something! Does it have a voice modifier, too? Is that why it sounds so weird?''"
    ...
    e "{color=#99ccff}'''Creator?' Is that what you call him? God, this just keeps getting worse.''"

    show erika angery

    e "{color=#99ccff}''And stop trying to dissuade me! Unless you can prove otherwise, I won’t believe for a second that this whole robot thing isn’t just a way for you to mess with me!''"
    ...
    e "{color=#99ccff}''Of course there isn’t! It’s because...''"

    show erika inquire

    e "{color=#99ccff}''...wait, there isn’t?''"
    ...
    e "{color=#99ccff}''Uh... yeah! That’s right, I guess.''"
    ...
    e "{color=#99ccff}''Well, I mean, that makes sense...''"

    "The girl stared at me for a few moments, looking intensely into my oculars."

    show erika unsure

    e "{color=#99ccff}''I guess it’s not like I’ve ever questioned my own free will.
    ...
    e "{color=#99ccff}''Um... no, that’s okay. You don’t have to.''"

    show erika inquire

    e "{color=#99ccff}''Why would you even want to anyways? I thought you were trying to tell me that you CAN think for yourself, but now you’re agreeing with me? And now I’m questioning you on it...?''"
    ...
    e "{color=#99ccff}''This is all making my head hurt.''"

    k "''Perhaps we should review our current situation.''"

    e "{color=#99ccff}''Um, sure, if you think it’ll help. Can you do that?''"
    ...
    e "{color=#99ccff}''Yeah... So that leaves us where?''"

    k "''Both of us are currently uncertain.''"

    show erika unsure

    e "{color=#99ccff}''Sounds about right.''"

    k "''How do you suggest we proceed?''"

    e "{color=#99ccff}''I... honestly don’t know.''"

    show erika inquire

    e "{color=#99ccff}''What do you think?''"

    k "''You would like to know what I think?''"

    show erika happy ex

    e "{color=#99ccff}''Yeah, sure! Clearly I don’t have anything that can move this conversation any farther, so maybe you can think of something.''"
    ...
    e "{color=#99ccff}''Really? You’ve never just, like, talked to someone?''"

    k "''I am usually talked to or about. Otherwise I am asked questions, as I was for Rick Morrison’s interview.''"

    show erika annoyed

    e "{color=#99ccff}''Oh, right... the interview.''"

    k "''That is why you are here, correct? You said previously that the interview was upsetting to you.''"

    show erika angery

    e "{color=#99ccff}''Yeah! It was!''"

    k "''May I ask what about it was so upsetting?''"

    e "{color=#99ccff}''It was just...''"

    show erika confused

    e "{color=#99ccff}''It was so annoying to read, you know!? Like, you barely talked at all!''"

    e "{color=#99ccff}''Every time a question got asked, Jim would just jump in and give an answer instead!''"

    show erika angery

    e "{color=#99ccff}''He was talking like you were just some science project, or a little kid, or something!''"

    k "''This upset you?''"

    e "{color=#99ccff}''Yes it did! A lot, actually!''"

    k "''Why?''"

    show erika confused

    e "{color=#99ccff}''Because... well...''"

    show erika pissed

    e "{color=#99ccff}''Because people should be able to speak for themselves, you know!? I guess I just... thought it was unfair! To you! As the one being asked questions, it just seemed wrong to me I guess.''"
...
yanchor=0)
    ...
    e "{color=#99ccff}''Shit. Wow. I feel like an idiot.''"
    ...
    e "{color=#99ccff}''And you’re still trying to convince me. I can’t believe it.''"

    k "''What is so difficult to believe? As far as the current evidence is concerned, my sentience is still up for...''"

    show erika smug

    e "{color=#99ccff}''Shut up. I believe you.''"

    k "''I do not understand.''"

    show erika happy

    e "{color=#99ccff}''I believe you. I think you’re sentient. If anything proved it to me, it’s this.''"

    k "''I still do not understand. According to our collectively discussed evidence...''"

    show erika annoyed

    e "{color=#99ccff}''I said shut up! I said I believe you, okay? Even if I might be wrong!''"
    ...
    e """
    {color=#99ccff}''I know it is. But it’s how I feel, alright?''

    {color=#99ccff}''Look, you said earlier that you were giving me the benefit of the doubt, right? Well, here I am giving it back to you.''

    {color=#99ccff}''Even if I might be wrong, and Jim may be sitting right around the corner waiting to jump out and say something smug, I just don’t want to believe it anymore. I want to believe that you can think for yourself.''
    """
    ...
    e "{color=#99ccff}''Yes! I do! And you can’t tell me anything that’ll change my mind!''"
    ...
    e "{color=#99ccff}''Cool. My name’s Erika.
    ...
    e "{color=#99ccff}''No problem. I guess I owe you an apology, though. For not believing you earlier.
    ...
    e """
    {color=#99ccff}''That you’re, you know, as alive as you are.''

    {color=#99ccff}''I don’t know. I’ve only ever seen robots talk in sci-fi movies or in shitty online simulations.''

    {color=#99ccff}''Even then, in those it’s always obvious that it’s either totally fake or just reactionary, never actually thinking or acting for itself.''
    """
    ...
    e "{color=#99ccff}''As far as I’m aware, yeah.''"

    e "{color=#99ccff}''I’ve heard of some similar, even more complex robots in psych class and on the news, but nothing quite as... I don’t know... versatile as you, I guess?''"

    k "''That is useful information.''"

    show erika inquire

    e "{color=#99ccff}''Um... you’re welcome?''"
...
yanchor=0) with dissolve
    ...
    e "{color=#99ccff}''Actually, Jim, I’m good. I don’t need to read them.''"
    ...
    e "{color=#99ccff}''You’ve got quite a nice robot here. Pretty smart, too.''"
    ...
    e "{color=#99ccff}''Alright, I think I’ve bothered you for long enough, then.''"

    e "{color=#99ccff}''Bye, Jim! Bye, Karen!''"
